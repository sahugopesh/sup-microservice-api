...
import com.efx.sup.Application;
import com.efx.sup.api.rest.SUPController;
...
public class DataControllerTest {
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        Data r1 = mockData("shouldCreateRetrieveDelete");
        ...
        mvc.perform(get("/example/v1/hotels/" + id)
                ...
                .andExpect(jsonPath("$.name", is(r1.getBillingData())))
                .andExpect(jsonPath("$.city", is(r1.getInvoicePrice())));
 ...
 */
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {
        Data r1 = mockData("shouldCreateAndUpdate");
        byte[] r1Json = toJson(r1);
        //CREATE
        MvcResult result = mvc.perform(post("/example/v1/hotels")
                .content(r1Json)
        ...
        Data r2 = mockData("shouldCreateAndUpdate2");
        r2.setId(id);
        ...
        mvc.perform(get("/example/v1/hotels/" + id)
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is((int) id)))
                .andExpect(jsonPath("$.name", is(r2.getBillingData())))
                .andExpect(jsonPath("$.rating", is(r2.getInvoicePrice())));
    ...
    ******************************
    ...
    private Data mockData(String prefix) {
        Data r = new Data();
        r.setBillingData(prefix + "_city");
        r.setInvoicePrice(new Random().nextInt(6));
        return r;
    }
